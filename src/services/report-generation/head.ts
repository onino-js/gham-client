export const reportHead = () => {
  return `<head>
	...
	<style type="text/css">
		...
		p.western { font-family: "Liberation Serif", serif; font-size: 12pt; so-language: fr-FR }
		...
		td p.western { font-family: "Liberation Serif", serif; font-size: 12pt; so-language: fr-FR }
